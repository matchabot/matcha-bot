---
title: 🙋‍♂️ What is MatchaBot ? # Title of your page
slug: /docs/introduction/what-is-matchabot # Slug of your page (uses file name as default)
...
- **Generators** live in the folder structure of a project in the **\_matchabot** directory
...
- A generator is defined by a folder inside the **\_matchabot** directory
  ...
  - A **generator** can include one or multiple **commands**: **commands** are defined as subdirectories, each command is defined by a **matchabot.cmd.json** file at the root of each **command directory**
